...
const steps: Step[] = [
  {
    ...
    description:
      "Authors submit a short abstract describing the work they intend to present. It goes through the same submission system as the full paper.",
    dateLabel: "Abstract deadline",
    date: formatDate(conference.dates.abstractDeadline),
  },
  {
    id: "submit",
    label: "Full-paper Submit",
  ...
  },
  {
    ...
    description: `The ${conference.reviewProcess.committeeName} reviews each paper. There's no separate deadline for this step, and it will start as soon as submissions are closed.`,
    dateLabel: null,
    date: null,
  },
  {
  ...
  },
  {
    ...
    description: "Accepted authors submit a final camera-ready version by incorporating reviewer feedback.",
  ...
  },
  {
    ...
    href: "/submission#presentation",
    description: "At least one author of accepted papers must register to present the paper at the conference.",
  ...
  },
  {
    ...
    href: "/registration",
    description:
      "The early registration window for anyone closes. Regular registration opens the following day and stays open until the conference dates.",
  ...
  },
  {
    ...
    label: "Present",
    href: "/submission#presentation",
    description: "Authors with accepted papers will present their work, via either oral or poster, at the conference.",
